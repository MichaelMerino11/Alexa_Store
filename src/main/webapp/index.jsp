  ...
  <body>
    <header>
      ...
      <nav>
        <ul class="nav-links">
          <li>
            <img
              src="./Imagenes/alexa_web_icon.png"
              alt="Alexa icon"
              height="30px"
            />
          </li>
        </ul>
        <form id="search-form" class="search-bar" action="#" method="GET" onsubmit="buscarProducto(); return false;">
          <input
          id="searchInput"
          type="text"
          name="search"
          ...
          <ul class="category_list">
            <li>
              <button
                ...
                data-category="echo_dot"
                onclick="filterProducts('echo_dot')"
              >
                Echo Dot
              </button>
            </li>
            <li>
              <button
                class="category_button"
                data-category="echo_studio"
                onclick="filterProducts('echo_studio')"
              >
                Echo Studio
              </button>
            </li>
            <li>
              <button
                class="category_button"
                data-category="echo_show"
                onclick="filterProducts('echo_show')"
              >
                Echo Show
              </button>
            </li>
            <li>
              <button
                class="category_button"
                data-category="echo_flex"
                onclick="filterProducts('echo_flex')"
              >
                Echo Flex
              </button>
            </li>
        ...
        <div class="container mt-5">
          <div class="row">
            ...
            <div class="col-md-4 echo_dot" data-producto="echo_dot_4">
              <div class="card">
                <img
                  src="./Imagenes/echoDot4taReloj.jpeg"
                  class="card-img-top"
    ...
    <footer class="bg-dark text-center text-lg-start">
      <div class="container p-4">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            <h6 class="text-uppercase text-white"><strong>Contacto</strong></h6>
            <ul class="list-unstyled mb-0">
              <li class="text-white">Correo: maikijunior9@gmail.com</li>
              <li class="text-white">Teléfono: +593 984571226</li>
              <li class="text-white">
                Dirección: Calle Chávez 411, Quito, Ecuador
              </li>
            </ul>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            <h6 class="text-uppercase text-white"><strong>Síguenos</strong></h6>
            <a
              href="https://www.facebook.com/michaelandres.junior11"
              class="me-4 text-reset text-decoration-none"
              ><img src="./Imagenes/facebook.png" alt="Facebook" height="30px"
            /></a>
            <a
            ...
            <a
              ...
              class="me-4 text-reset text-decoration-none"
              ><img src="./Imagenes/twitter.png" alt="Twitter" height="30px"
            /></a>
            <a
              href="https://www.linkedin.com/in/michael-merino-0b7871207/"
              class="me-4 text-reset text-decoration-none"
              ><img src="./Imagenes/linkedin.png" alt="LinkedIn" height="30px"
            /></a>
          </div>
          <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
            <h6 class="text-uppercase text-white"><strong>Autores</strong></h6>
            <ul class="list-unstyled mb-0">
      ...
      <div class="text-center p-3 text-white">
        © 2024 Derechos reservados Michael Merino
      </div>
    </footer>
